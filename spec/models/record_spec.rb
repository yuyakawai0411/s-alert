  ...
  describe '着信履歴登録' do
    ...
    context '着信履歴登録できないとき' do
      ...
      it '日付が空では登録できない' do
        record.date = ''
        record.valid?
        is_expected.to include "日付を入力してください"
      end
      it '時間が空では登録できない' do
        record.phone_time_id = ""
        record.valid?
        is_expected.to include "時間は指定の範囲内で選択してください"
      end
      ...
      it '感情が空では登録できない' do
        ...
        record.valid?
        is_expected.to include "感情は指定の範囲内で選択してください"
      end
      ...
      it '着信有無が空では登録できない' do
        ...
        record.valid?
        is_expected.to include "着信有無を入力してください"
      end
    end
  end
